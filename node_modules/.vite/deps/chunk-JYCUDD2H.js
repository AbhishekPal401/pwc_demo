...
var NativeInteractionClient = class extends BaseInteractionClient {
  ...
  async handleNativeResponse(response, request, reqTimestamp) {
    ...
    const baseAccount = buildAccountToCache(this.browserStorage, authority, homeAccountIdentifier, idTokenClaims, base64Decode, response.client_info, idTokenClaims.tid, void 0, response.account.id, this.logger);
...
var TokenCache = class {
  ...
  loadAccount(idTokenClaims, authority, clientInfo, requestHomeAccountId) {
    if (this.isBrowserEnvironment) {
      ...
      const cachedAccount = buildAccountToCache(this.storage, authority, homeAccountId, idTokenClaims, base64Decode, clientInfo, claimsTenantId, void 0, void 0, this.logger);
...
@azure/msal-browser/dist/controllers/StandardController.mjs:
  (*! @azure/msal-browser v3.6.0 2023-12-01 *)
*/
//# sourceMappingURL=chunk-JYCUDD2H.js.map
