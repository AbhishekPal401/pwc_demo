...
var NestedAppAuthAdapter = class {
  ...
  fromNaaTokenResponse(request, response, reqTimestamp) {
    ...
    const expiresOn = new Date((reqTimestamp + (response.expires_in || 0)) * 1e3);
    const idTokenClaims = AuthToken_exports.extractTokenClaims(response.id_token, this.crypto.base64Decode);
...
@azure/msal-browser/dist/controllers/NestedAppAuthController.mjs:
  (*! @azure/msal-browser v3.6.0 2023-12-01 *)
*/
//# sourceMappingURL=NestedAppAuthController-XPOSV55X.js.map
