...
${serverError}`);
  ...
  generateCacheRecord(serverTokenResponse, authority, reqTimestamp, request, idTokenClaims, userAssertionHash, authCodePayload) {
    ...
    if (serverTokenResponse.id_token && !!idTokenClaims) {
      ...
      cachedAccount = buildAccountToCache(this.cacheStorage, authority, this.homeAccountIdentifier, idTokenClaims, this.cryptoObj.base64Decode, serverTokenResponse.client_info, claimsTenantId, authCodePayload, void 0, this.logger);
    }
...
function buildAccountToCache(cacheStorage, authority, homeAccountId, idTokenClaims, base64Decode2, clientInfo, claimsTenantId, authCodePayload, nativeAccountId, logger) {
...
@azure/msal-browser/dist/event/EventHandler.mjs:
  (*! @azure/msal-browser v3.6.0 2023-12-01 *)
*/
//# sourceMappingURL=chunk-ASZ2H5FJ.js.map
